import { getDateOffset } from './datetime-ops';
...
function before (duration, timestamp, enableUTC, weekStartFrom) {
  ...
  return getDateOffset(!isNaN(timestamp) ? timestamp : +new Date(), duration.Unit, -duration.number, enableUTC, weekStartFrom || Weekdays.Sunday);
}
